...
namespace SeturContactList.UnitTest
{
    public class PersonApiControllerTest
    {
        ...
        private Guid newPersonId = Guid.NewGuid();
        ...
        [Fact]
        public async void GetPerson_IdInValid_ReturnNotFound()
        {
        ...
        [Fact]
        public async void GetPerson_IdValid_ReturnOkResult()
        {
        ...
        [Fact]
        public async void DeletePerson_ActionExecute_ReturnNoContent()
        {
            var person = persons.First();
            Guid personId = person.Id;
        ...
        public async void PostPersonContact_ActionExecutes_ReturnWithPersonContactId()
        {
            ...
            _personsService.Setup(x => x.GetByIdAsync(newPerson.Id)).ReturnsAsync(person);
        ...
        [Fact]
        public async void DeletePersonContact_ActionExecute_ReturnNoContent()
        {
            var personContact = personContacts.First();
            Guid personContactId = personContact.Id;
        ...
        [Fact]
        public async void GetPersonContact_IdInValid_ReturnNotFound()
        {
            Guid personContactId = Guid.NewGuid();
